package com.projects.gradesubmissionbackend;
...
public class GradeSubmissionBackendApplication /* implements CommandLineRunner */ {
	
	// StudentRepository studentRepository;
	// CourseRepository courseRepository;

	// public GradeSubmissionBackendApplication(StudentRepository studentRepository, CourseRepository courseRepository) {
	// 	this.studentRepository = studentRepository;
	// 	this.courseRepository = courseRepository;
	// }

	public static void main(String[] args) {
		SpringApplication.run(GradeSubmissionBackendApplication.class, args);
	}
